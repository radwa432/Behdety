...
import { SitesByGovernmentComponent } from './components/site-by-government/sites-by-government.component';
...
export const routes: Routes = [
  ...
  {
    path: 'government/:id',
    component: SitesByGovernmentComponent  
  },
  {
    path: '',
